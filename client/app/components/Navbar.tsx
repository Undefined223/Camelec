...
import { faBasketShopping, faHeart, faUser, faSearch, faChevronDown, faBars } from "@fortawesome/free-solid-svg-icons";
                ...
                <motion.div className="relative flex items-center gap-2 ml-auto" variants={itemVariants}>
                    {user ? (
                        <>
                            <motion.div
                                ...
                                whileTap={{ scale: 0.9 }}
                                className="flex items-center gap-2 border-l border-slate-300 pl-6" // Updated to flex and gap-2 for spacing
                            >
                                <FontAwesomeIcon
                                    icon={faUser}
                        ...
                        <>
                            <motion.div
                                whileHover={{ scale: 1.1 }}
                                whileTap={{ scale: 0.9 }}
                                className="flex items-center gap-2 border-l border-slate-300 pl-6" // Changed to flex and added gap-2
                            >
                                <FontAwesomeIcon icon={faUser} className="text-2xl cursor-pointer mb-1 text-[#2DACD9]" onClick={toggleMenu} />
                                <span className="text-xs hidden md:block">Account</span>
                    ...
                    <Link href='/cart'>
                        <motion.div
                            whileHover={{ scale: 1.1 }}
                            whileTap={{ scale: 0.9 }}
                            className="relative flex items-center gap-2 border-l border-slate-300 px-6"  // Changed from flex-col to flex and added gap-2 for spacing
                        >
                            ...
                            <span className="text-xs hidden md:block">Cart</span> {/* Text beside the icon */}
                        </motion.div>
                    </Link>
                    <Link href='/wishlist'>
                        <motion.div
                            whileHover={{ scale: 1.1 }}
                            whileTap={{ scale: 0.9 }}
                            className="relative flex items-center gap-2 border-l border-slate-300 pl-6"  // Changed from flex-col to flex and added gap-2 for spacing
                        >
                            <div className="relative">
                            ...
                            <span className="text-xs hidden md:block">Wishlist</span> {/* Text beside the icon */}
                        </motion.div>
                    </Link>
                </motion.div>
            </div>
            ...
            <div className="relative hidden md:block">
                <AnimatePresence>
                    {dropdownOpen && (
                        ...
                        >
                            <div
                                className="flex w-64 h-full border-r border-gray-200" // Added border-r here
                            >
                                ...
                                <div className="w-1 bg-transparent h-full" /> {/* Invisible bridge */}
                            </div>
                            <div
