...
const DropdownNotification = () => {
  ...
  // Update unread status based on filtered notifications
  useEffect(() => {
          ...
          >
            ...
            <ul className="flex h-auto flex-col overflow-y-auto">
              ...
              {notifications.length === 0 && (
                <li className="px-4.5 py-3 text-center text-sm text-gray-500 dark:text-gray-400">
