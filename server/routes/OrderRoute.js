...
const { createOrder, getOrdersByUser, getOrders, updateOrderStatus, getPendingOrders, OrderDeliverySubmit, getOrderById, getProcessingOrders, getOrdersByCity, getorderStatus } = require('../controllers/OrderController');
...
router.get("/status", protect, admin, getorderStatus)
